     ...
     F                                      PREFIX(W_)
     FHOLIDAYS  IF A E           K DISK
     FHOLIDAYL  UF   E           K DISK     PREFIX(W_)
     FADMINDASH CF   E             WORKSTN SFILE(ADMINRCD:RRN)
     F                                      SFILE(VIEWHOLDY:RRN1)
     ...
     //FREE
      ...
      //******************* UPDTEMP ****************************************
        ...
        // RECORDS ADDITION
         ...
         //Character Validations (Name, City,Country, Designation)
             ...
             if MSG = *BLANKS and $EMPEMLO2 <> *BLANKS;
                posAt = %scan('§' : $EMPEMLO2);
      ...
      //********************* DELTEEMP SR **********************************
             ...
             // Delete from EMPMASTER (via LF)
             CHAIN W_EMPID EMPMTERL;
             IF %FOUND(EMPMTERL);
                DELETE EMPRECL;
             ENDIF;

             // Delete from LOGIN PF
             CHAIN W_EMPID LOGIN;
             IF %FOUND(LOGIN);
                DELETE LOGINREC;
             ENDIF;

             // Delete from LEAVEBAL PF
        ...
        begsr ADDHLD;
            ...
            dow *in03 = *off;
             ...
             // 1. Mandatory Field Check
                // if $HLDATE1 = 0 or
                 // %trim($HLDAY1) = *BLANKS or
              if %trim($HLRMRK1) = *BLANKS;

                  MSG = 'All fields are mandatory.';
                iter; // Restart the loop to show the error
              endif;
             ...
             if MSG = *BLANKS;
                ...
                TEST(DE) *ISO $HLDATE1;
                 if %error;
                    MSG = 'Invalid DATE. Use YYYYMMDD format.';
                  else;
                    d_doj = %DATE($HLDATE1 : *ISO);
                 endif;
             endif;
              ...
              //3. F4 PROMPT LOGIC
               ...
               if *in04 = *on;
                 ...
                 if P_FLD = '$HLDAY1';
                     ...
                     select;
                        when %TRIM($HLDAY1) = *BLANKS;
                                   $HLDAY1 = 'MONDAY';

                        when %TRIM($HLDAY1) = 'MONDAY';
                                   $HLDAY1 = 'TUESDAY';

                        when %TRIM($HLDAY1) = 'TUESDAY';
                                   $HLDAY1 = 'WEDNESDAY';

                        when %TRIM($HLDAY1) = 'WEDNESDAY';
                                    $HLDAY1 = 'THURSDAY';

                        when %TRIM($HLDAY1) = 'THURSDAY';
                                  $HLDAY1 = 'FRIDAY';

                        when %TRIM($HLDAY1) = 'FRIDAY';
                                   $HLDAY1 = 'SATURDAY';

                        when %TRIM($HLDAY1) = 'SATURDAY';
                                   $HLDAY1 = 'SUNDAY';

                        other;
                            $HLDAY1 = 'MONDAY';
                     endsl;
                     MSG = 'Day Selected:' + %TRIM($HLDAY1);
                     *in50 = *on;         //Keep cursor on at Day
                    *in04 = *off;
                    iter; // Go back to display the screen with the new value
                  endif;
               endif;

               //4. TO FIX EMPTY RECORDS
               if *in03=*on or *in12=*on;
                   *in03=*off;
                   *in12=*off;
                   leave;
          ...
          //******************* UPDTHOL ************************************
           begsr UPDTHOL;
                 ...
                 dow *in03=*off;
                      ...
                      // 1. Mandatory Field Check
                        // if $HLDATE2 = 0 or
                         //  %trim($HLDAY2) = *BLANKS or
                      if %trim($HLRMRK2) = *BLANKS;
              ...
              // 3. F4 PROMPT LOGIC
               ...
               if *in04 = *on;
                 ...
                 if P_FLD = '$HLDAY2';
                     ...
                     select;
                        when %TRIM($HLDAY2) = *BLANKS;
                                   $HLDAY2 = 'MONDAY';

                        when %TRIM($HLDAY2) = 'MONDAY';
                                   $HLDAY2 = 'TUESDAY';

                        when %TRIM($HLDAY2) = 'TUESDAY';
                                   $HLDAY2 = 'WEDNESDAY';

                        when %TRIM($HLDAY2) = 'WEDNESDAY';
                                    $HLDAY2 = 'THURSDAY';

                        when %TRIM($HLDAY2) = 'THURSDAY';
                                   $HLDAY2  = 'FRIDAY';

                        when %TRIM($HLDAY2) = 'FRIDAY';
                                   $HLDAY2 = 'SATURDAY';

                        when %TRIM($HLDAY2) = 'SATURDAY';
                                   $HLDAY2 = 'SUNDAY';

                        other;
                            $HLDAY2 = 'MONDAY';
                     endsl;
                     MSG = 'Day Selected:' + %TRIM($HLDAY2);
                     *in51 = *on;         //Keep cursor on at Day
                    *in04 = *off;
                    iter; // Go back to display the screen with the new value
                  endif;
               endif;
