         ...
         *inlr = *on;
         ...
         begsr LOAD_PENDING_LEV;
               ...
               dow not %eof;
                     ...
                     // Manager filter: only load leaves for this manager's team
                     chain $EMPID EMPMASTER;
                     if %found(EMPMASTER) and EMPMGRID = P_MGRID;
                        $EMPNAM  = EMPNAM;
                        $LVEFRDT = LVEFRDT;
                        $LVETODT = LVETODT;
                        $LVETDAY = LVETDAY;
        ...
        //********* END OF APPROVE_LVE_PROC ***********************
         ...
         begsr LOAD_PENDING_COMP;
               ...
               dow not %eof;
                     ...
                     // Manager filter: only load comp-offs for this manager's team
                     chain $EMPID EMPMASTER;
                     if %found(EMPMASTER) and EMPMGRID = P_MGRID;
                        $EMPNAM  = EMPNAM;
                        $COMWRDT = COMWRDT;
